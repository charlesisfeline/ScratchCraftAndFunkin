...
local ofsy = 0
local mult = 1.25
characterNames = {'bf', 'pico-player', 'dad', 'spooky', 'mom', 'monster', 'senpai', 'spirit'} --character json name
characterDisplays = {'boyfriend', 'pico', 'dad', 'spooky kids', 'mom', 'monster', 'senpai', 'spirit'} --display name for text
...
function setVariation()
  ...
  elseif variation == 2 then
    characterNames = {'bf-christmas', 'pico-player', 'dad', 'spooky', 'mom', 'monster-christmas', 'senpai-angry', 'spirit'} --character json name
    characterDisplays = {'boyfriend (christmas)', 'pico', 'dad', 'spooky kids', 'mom', 'monster (christmas)', 'senpai (mad)', 'spirit'} --display name for text
  elseif variation == 3 then
    characterNames = {'bf-pixel', 'pico-player', 'dad', 'spooky', 'mom', 'monster-christmas', 'senpai-angry', 'spirit'} --character json name
    characterDisplays = {'boyfriend (pixel)', 'pico', 'dad', 'spooky kids','mom', 'monster (christmas)', 'senpai (mad)', 'spirit'} --display name for text
  end
end
